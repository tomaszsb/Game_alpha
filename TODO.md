...
**Current Version:** 3.0.118 (not yet deployed — v3.0.116–118 pending)
...
- [ ] **New starting scenario: cash-strapped homeowner facing a Notice of Violation** — direct player comment (2026-07-12, screenshot, not a dashboard report): *"There is no use of this game for a typical homeowner who got a specific tragic situation with notice of violation and want to play any specific scenario with the game, becauce he has limited mony on the pocket and facing a profesional to hire who want too much money for his service — so create a new starting situation in your game."* Reads as: the current default start (an owner/developer with meaningful seed capital) doesn't represent a homeowner who's already in trouble — cited an NYC "Notice of Violation" (DOB/HPD enforcement action) and being cash-poor against paying a design/expediting professional. Requesting an alternate starting scenario (lower starting money, mid-project/violation-triggered entry point) rather than a bug fix. Needs a scope decision before any content/engine work: is this a new selectable starting preset, a different starting-money value, or a whole new narrative branch?
