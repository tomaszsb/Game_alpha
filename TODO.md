...
- [ ] **Tile space names ≠ player-panel space names** — Names shown on the board tiles don't match the names shown in the player panel — confusing. Naming inconsistency to chase across both surfaces. Reported under v3.0.4. <!-- fb:feedback-1779515740138-41e35769 -->
- [ ] **Locked tiles grow and overlap neighbors** — Two-part: (a) when a tile locks in place it grows and now overlaps surrounding tiles — leave enough room between tiles for the locked size, (b) the current tile should be **fully expanded** and the available-move tiles should be **hover-sized**, not all the same. Reported under v3.0.4. <!-- fb:feedback-1779515660496-97fa9c75 -->
- [ ] **Show only the path taken, not all arrows** — Wayfinding feedback: the full forward-arrow web is noisy; show just the route the player has actually traveled. Likely overlaps the existing "Arrows too long" (`fb:feedback-1778864351916-7c972948`) and "Arrow overlaps a box" (`fb:feedback-1778864793831-30be69b2`) line items. Reported under v3.0.0. <!-- fb:feedback-1779512747985-96317d74 -->
