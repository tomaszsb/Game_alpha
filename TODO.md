...
- [ ] **G160: per-edge waypoint redirect** — approved by the maintainer 2026-08-02 (see CHANGELOG), ready to scope/build next session. Redirects a specific auto-routed connection that's genuinely wrong/confusing (the simpler show/hide toggle + per-edge click-to-hide already shipped in v3.1.49). See BETA_PLAN_V3.md for original spec context. <!-- fb:feedback-1778327469678-d27a73d0 -->
