...
- [x] **Phase 4 — Card insertion** — DONE: teacher-authored spaces ("replace one card with several") merged + deployed live (pre-v3.0.87). The gate (Phases 1–3 live) was cleared and the feature shipped. See CHANGELOG.
