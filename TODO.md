...
- [ ] **Dictionary — underlined words missing** — Playtester opened dictionary; expected term-underlines absent. Possible Workstream 5 live-dictionary load gap or TextWithTerms regression. <!-- fb:feedback-1779569587994-00d1db0a -->
- [ ] **TV mode: center view on current tile + zoom to fit valid moves** — When no player is set (TV display), pan + zoom so the active tile and all valid-move neighbors are fully visible. <!-- fb:feedback-1779569130947-9c075c16 -->
- [ ] **Action counter on current space tile (bottom right)** — Render "X actions left" on the active tile itself, not just in player panel. <!-- fb:feedback-1779568815545-44221318 -->
- [ ] **Consolidate player-name displays — drop side panel for board real estate** — Player names render in two places (top + side panel). Move all to top, remove side panel, give the board more room. <!-- fb:feedback-1779568265597-9bedb559 -->
- [ ] **TV mode: indicator that player controls actions via phone (+ phone vibration?)** — At game start on TV, nothing signals that the phone is the controller. On-screen indicator + optional phone-side vibration cue. <!-- fb:feedback-1779567746328-5ca98777 -->
- [ ] **Phone name entry — keyboard hides the typing area** — When the on-screen keyboard pops up on a phone during name entry, the input field scrolls out of view. <!-- fb:feedback-1779567253915-4b07b80a -->
- [ ] **Phone setup — player panels don't fit the screen** — During name entry on a phone, the player panels overflow horizontally. <!-- fb:feedback-1779566484383-02bb1588 -->
