...
export const createMockDataService = (): any => ({
  ...
  getSpaceForApprovalRole: vi.fn(() => null),
  getNpcSpeakerAssignments: vi.fn(() => []),
  getCardTypeLabels: vi.fn(() => []),
  ...
  getProjectScopeCardTypes: vi.fn(() => ['W']),
  isProjectScopeCard: vi.fn((cardId: string) => cardId.startsWith('W')),
