...
**Current Version:** **3.0.137** — **3.0.115 deployed 2026-07-12** (commit `b46cb30`, confirmed by maintainer); **v3.0.116–137 built and pushed, not yet confirmed deployed.**
...
- **Deploy:** live = v3.0.115 (last maintainer-confirmed). v3.0.116–137 built and pushed, awaiting the next `deploy.sh` run and confirmation.

## Top open items (full list in TODO.md + .claude/NEXT_SESSION.md)
1. **Deploy v3.0.116–137**, then run the dashboard PATCH sweep for reports closed in that range (fb:f453b1f3, fb:7dbc2fcc confirmed closeable; TV-mode fixes fb:3f9f2831/fb:e121c34e need real-hardware confirmation first, not auto-flippable).
