...
1. **Live post-deploy verification** — author a space in the live app (Admin Tools → 🏫 Classroom Setup) and walk through it; the last "see it work in the real running app" step.
