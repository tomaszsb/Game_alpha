...
## Health
- **Tests:** typecheck ✅ clean, build ✅ clean. Full suite (backgrounded, took ~10.6 min — ghost-bot simulations run 50 games each): **2340/2341 passing, 1 skipped**, matching the pre-session baseline exactly (no regressions).
