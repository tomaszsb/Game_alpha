...
**Current Version:** **3.0.82** — committed + pushed to master, **pending deploy** (user deploying). v3.0.81 was deployed live earlier this session (commit `e85da2c`).
