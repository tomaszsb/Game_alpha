...
**Charter Version:** 3.66 (added the "migrating tests off deleted code: verify the tested scenario still exists" TACTICAL entry — E2E-05 L003 migration + the N×N fan-out find, 2026-07-18 session, v3.1.9–v3.1.10.
