...
**Charter Version:** 3.54 (added "A broken `<img>` anywhere kills the whole app — preload off-DOM" + the GameTour carousel / Puppeteer screenshot-capture tooling notes, v3.0.96. Prior 3.53: "Mounting a new top-level entry point without touching App.tsx" + PWA manifest icon-size gotcha. 3.52: TWO parallel card-play effect parsers.)
