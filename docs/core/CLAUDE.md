...
**Charter Version:** 3.63 (added the React Flow `onMoveEnd`-fires-on-programmatic-moves TACTICAL entry and the embedded-browser-animation-frame-throttling TACTICAL entry, 2026-07-16 session, v3.1.2.
