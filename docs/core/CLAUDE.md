...
**Charter Version:** 3.89 (2026-09-17, v3.2.61 session: added two TACTICAL entries — html2canvas clips fixed elements to an overflow:hidden ancestor, and Vite's watcher can miss an edit, so curl the served module before debugging a live check.)
