...
**Charter Version:** 3.92 (2026-09-19, v3.2.71 planning + slice 1: added one TACTICAL entry with three findings — raw engagement counts are mostly the nightly robot (filter by UA and home IP; 37 real games of 187), an overlaid control takes no layout room so a mirrored panel needs a real-browser look, and a page that outlived a server restart lies.)
