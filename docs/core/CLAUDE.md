...
**Charter Version:** 3.65 (added the "dead-code check applies one level up, to a whole component cluster" TACTICAL entry — `PlayerActionService.playCard()`/`CardModal` orphan cluster, 2026-07-17 session, v3.1.8.
