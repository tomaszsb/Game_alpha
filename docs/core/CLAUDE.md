...
**Last Updated:** June 26, 2026 (Session 2026-06-26 — **shipped + deployed live v3.0.85 (`de5c363`) + v3.0.86 (`6e017d7`).** v3.0.85: Pile 2 panel UX (icons/glow/checkmark-trace/reversible-move) + expeditor phase-gate correctness fix + SETUP→OWNER relabel + the held 2026-06-25 fixes. v3.0.86: Pile 3 change-legibility — between-turns move popup, "My numbers" recall modal, "History" Chronicle first slice. All new-panel work behind the opt-in toggle. Typecheck + build clean; targeted sweep 1714/1714 green.)
**Charter Version:** 3.48 (added the "card-play phase gating lives in the shared canPlayCard + two unrelated SETUPs" TACTICAL note. Prior 3.47: "inline gridRow collides under single-column media query". 3.46: "Walking an authored space locally + validator/engine dice-detection drift".)
