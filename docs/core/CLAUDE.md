...
**Charter Version:** 3.52 (added "TWO parallel card-play effect parsers" — CardService.parseCardIntoEffects vs EffectFactory.createEffectsFromCard, which path each UI uses, and the v3.0.94 double-tick lesson. Prior 3.51: negative-money-guards update for v3.0.92. 3.50: TWO negative-money guards, the v3.0.91 economy change.)
