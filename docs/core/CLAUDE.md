...
**Charter Version:** 3.53 (added "Mounting a new top-level entry point without touching App.tsx" — the main.tsx pathname-branch pattern used for the /challenge landing page, plus the PWA manifest icon-size gotcha. Prior 3.52: TWO parallel card-play effect parsers, v3.0.94 double-tick lesson. 3.51: negative-money-guards update for v3.0.92.)
