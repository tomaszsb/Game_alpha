...
**Charter Version:** 3.49 (added the "no dice numbers or board-game icons in player copy" hard rule to the voice-rule TACTICAL note + fixed the stale "🎲 Deciding" cell. Prior 3.48: "card-play phase gating lives in the shared canPlayCard + two unrelated SETUPs". 3.47: "inline gridRow collides under single-column media query".)
